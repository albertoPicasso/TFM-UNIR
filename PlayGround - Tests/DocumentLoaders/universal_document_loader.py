...
from DocumentLoaders.baseDocumentLoader import BaseDocumentLoader
import re
import time
import pandas as pd

class Universal_document_loader(BaseDocumentLoader):
    ...
    def _extract_document_info(self, file:str) -> Document:
        ...
        try:
            ...
            if self.process_images:
                ...
                raise RuntimeError(f"Loader failed: {e}") from e
